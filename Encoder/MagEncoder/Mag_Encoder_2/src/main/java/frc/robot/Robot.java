...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		_talon.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative,	// Feedback
											0, 											// PID ID
											kTimeoutMs);								// Timeout
		talon_2 = new TalonSRX(4);
		_talon = new TalonSRX(3);
		talon_2.follow(_talon);
	}
	...
	public void teleopPeriodic() {
		_talon.set(ControlMode.PercentOutput, _joy.getRawAxis(0) * 0.5);
		/**
		 ...
		 */
		int selSenPos 
		= _talon.getSelectedSensorPosition(0);
		 ...
		 * degrees.
		 */
		System.out.print("pulseWidPos:"
						 + pulseWidthWithoutOverflows 
						 + "   =>    " 
						 + "selSenPos:" + selSenPos);
		System.out.print("      ");
		System.out.print("pulseWidDeg:" 
						 + ToDeg(pulseWidthWithoutOverflows) 
						 + "   =>    " + "selSenDeg:" 
						 + ToDeg(selSenPos));
		System.out.println();
	}
